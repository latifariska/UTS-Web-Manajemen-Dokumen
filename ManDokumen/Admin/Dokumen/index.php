...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO $page (nama, tanggal, judul_buku, alamat, no_hp, jenis_kelamin, file_buku) 
...
<form method="POST" action="" enctype="multipart/form-data">
    <h1 class="title" align="center">Formulir <?= $page ?></h1>
...
<div id="table">
    <fieldset class="background">
        <table class="table text-nowrap" border="1" cellpadding="5" cellspacing="5" align="center">
            <legend>
                <h2 class="title" align="center">Data Form <?= $page ?></h2>
            </legend>
            <thread>
                <tr>
            ...
            ?>
                <tr>
                    ...
                    <td align="center">
                        <a href="Dokumen/Edit.php?tabel=<?= $page ?>&id=<?php echo $row['id_buku'] ?>">Edit</a> |
                        <a href="Dokumen/Delete.php?tabel=<?= $page ?>&hapus_id=<?php echo $row['id_buku'] ?>">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
