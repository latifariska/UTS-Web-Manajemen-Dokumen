    ...
    <div id="table">
        <fieldset class="background">
            <table class= "table text-nowrap" border="1" cellpadding="5" cellspacing="5" align="center">
                <legend>
                    <h2 class="title" align = "center">Data Form Komik</h2>
                </legend>
                <thread>
                    <tr>
                ...
                ?>
                        <tr>
                            ...
                            <td align="center">
                        <a href="Komik/Edit.php?id=<?php echo $row['id_buku'] ?>">Edit</a> |
                        <a href="Komik/Delete.php?hapus_id=<?php echo $row['id_buku'] ?>">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
