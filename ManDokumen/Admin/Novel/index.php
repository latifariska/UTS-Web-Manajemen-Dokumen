...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO novel (nama, tanggal, judul_buku, alamat, no_hp, jenis_kelamin, file_buku) 
    ...
    <div id="table">
        <fieldset class="background">
            <table class= "table text-nowrap" border="1" cellpadding="5" cellspacing="5" align="center">
                <legend>
                    <h2 class="title" align = "center">Data Form Novel</h2>
                </legend>
                <thread>
                    <tr>
                ...
                ?>
                        <tr>
                            ...
                            <td align="center">
                        <a href="Novel/Edit.php?id=<?php echo $row['id_buku'] ?>">Edit</a> |
                        <a href="Novel/Delete.php?hapus_id=<?php echo $row['id_buku'] ?>">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
